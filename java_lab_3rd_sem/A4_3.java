...
class PublicBus extends Bus
{
    ...
    {
        super();
        System.out.println("PublicBus constructor called");
    }
...
class LuxuryPublicBus extends PublicBus
{
    ...
    {
        super();
        System.out.println("LuxuryPublicBus called");
    }
...
class A4_3 {
    public static void main(String[] args)
    {
        ...
        LuxuryPublicBus luxurybus = new LuxuryPublicBus();
        luxurybus.setDetalis(regdNo, model, capacity, owner, from, to, deptTime, arrivalTime, isAC, isWifi, noOfSleeperSeat);
